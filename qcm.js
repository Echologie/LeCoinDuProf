...
{
	if (region.am.F === region.aE.F)
	{
		return 'on line ' + region.am.F;
	}
	return 'on lines ' + region.am.F + ' through ' + region.aE.F;
}
...
var $author$project$QCM$Aremplacer = F2(
	function (_var, vals) {
...
var $author$project$Fractions$teX = function (a) {
	var _v0 = a.f;
	if (_v0 === 1) {
...
var $author$project$QCM$voirTexteVariable = function (txtvar) {
	if (!txtvar.$) {
		var txt = txtvar.a;
		return txt;
	} else {
		...
		if (expressionParseePotentielle.$ === 1) {
			...
			var _v2 = A2(
				$elm$core$Maybe$map,
				$author$project$Fractions$teX,
				$author$project$ParserMaths$evaluer(expressionParsee));
			if (!_v2.$) {
				var a = _v2.a;
				return a;
			} else {
				return 'Les puissances non-entières ne sont pas acceptées.';
			}
		}
	}
};
var $author$project$QCM$voirMacro = function (macro) {
	return $elm$core$String$concat(
		A2($elm$core$List$map, $author$project$QCM$voirTexteVariable, macro));
};
var $author$project$QCM$remplacerLesVariablesDansLaMacro = F2(
	function (ars, macro) {
		return A2(
			$elm$core$List$map,
			$author$project$QCM$voirMacro,
			A2(
				$author$project$QCM$remplacerLesVariablesDansLaMacroBis,
				ars,
				_List_fromArray(
...
var $author$project$QCM$remplacer = F2(
	function (variables, question) {
		var macro = $author$project$QCM$parserQuestion(question);
		var ars = A2(
			$elm$core$List$map,
			$author$project$QCM$parserAremplacer,
			$elm$core$String$lines(variables));
		return A2($author$project$QCM$remplacerLesVariablesDansLaMacro, ars, macro);
	});
var $author$project$QCM$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var nouvelleQuestion = msg.a;
				return _Utils_update(
					model,
					{G: nouvelleQuestion});
			case 1:
				var nouvellesVariables = msg.a;
				return _Utils_update(
					model,
					{L: nouvellesVariables});
			default:
				return _Utils_update(
					model,
					{
						M: A2($author$project$QCM$remplacer, model.L, model.G)
					});
		}
	});
var $author$project$QCM$GenererQuestion = {$: 2};
var $author$project$QCM$Question = function (a) {
	return {$: 0, a: a};
};
var $author$project$QCM$Variables = function (a) {
	return {$: 1, a: a};
};
	...
	return A2(
		...
		A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$placeholder('Liste des variables'),
						$elm$html$Html$Attributes$value(model.L),
						$elm$html$Html$Events$onInput($author$project$QCM$Variables)
					]),
				_List_Nil),
			A2(
				$elm$core$List$cons,
				A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$placeholder('Format de la question'),
							$elm$html$Html$Attributes$value(model.G),
							$elm$html$Html$Events$onInput($author$project$QCM$Question)
						]),
					_List_Nil),
				A2(
					$elm$core$List$cons,
					A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$QCM$GenererQuestion)
							]),
						_List_fromArray(
							[
...
var $author$project$QCM$main = $elm$browser$Browser$sandbox(
